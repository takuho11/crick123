 ...
 * PmsPlatformCddw 服务类
 */
@Service(value = "PmsPlatformCddwService")
public class PmsPlatformCddwService extends GenericService<PmsPlatformCddw> {

    public PmsPlatformCddwDao getPmsPlatformCddwDao() {
        return (PmsPlatformCddwDao) this.getGenericDao();
    }

    @Autowired
    public void setPmsPlatformCddwDao(PmsPlatformCddwDao pmsPlatformCddwDao) {

        this.setGenericDao(pmsPlatformCddwDao);
    }
