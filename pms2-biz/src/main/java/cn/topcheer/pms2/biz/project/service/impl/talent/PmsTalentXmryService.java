 ...
 * PmsTalentXmry 服务类
 */
@Service(value="PmsTalentXmryService")
public class PmsTalentXmryService extends GenericService<PmsTalentXmry> {

	public PmsTalentXmryDao getPmsTalentXmryDao() {
		return (PmsTalentXmryDao) this.getGenericDao();
	}

	@Autowired
	public void setPmsTalentXmryDao(PmsTalentXmryDao pmsTalentXmryDao) {

		this.setGenericDao(pmsTalentXmryDao);
	}
