 ...
 * PmsPlatformXmry 服务类
 */
@Service(value = "PmsPlatformXmryService")
public class PmsPlatformXmryService extends GenericService<PmsPlatformXmry> {

    public PmsPlatformXmryDao getPmsPlatformXmryDao() {
        return (PmsPlatformXmryDao) this.getGenericDao();
    }

    @Autowired
    public void setPmsPlatformXmryDao(PmsPlatformXmryDao pmsPlatformXmryDao) {

        this.setGenericDao(pmsPlatformXmryDao);
    }
