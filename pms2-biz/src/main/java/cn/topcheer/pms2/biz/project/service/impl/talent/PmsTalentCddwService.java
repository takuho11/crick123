 ...
 * PmsTalentCddw 服务类
 */
@Service(value = "PmsTalentCddwService")
public class PmsTalentCddwService extends GenericService<PmsTalentCddw> {

    public PmsTalentCddwDao getPmsTalentCddwDao() {
        return (PmsTalentCddwDao) this.getGenericDao();
    }

    @Autowired
    public void setPmsTalentCddwDao(PmsTalentCddwDao pmsTalentCddwDao) {

        this.setGenericDao(pmsTalentCddwDao);
    }
