...
import cn.topcheer.pms2.api.project.entity.projectBase.PmsProjectbaseCddw;

import cn.topcheer.pms2.biz.project.service.impl.PmsSaveAndInitNewService;
import cn.topcheer.pms2.dao.project.projectBase.PmsProjectbaseCddwDao;
...
/**
 * PmsProjectbaseCddw 服务类
 */
@Service(value = "PmsProjectbaseCddwService")
public class PmsProjectbaseCddwService extends GenericService<PmsProjectbaseCddw> {

    public PmsProjectbaseCddwDao getPmsProjectbaseCddwDao() {
        return (PmsProjectbaseCddwDao) this.getGenericDao();
    }

    @Autowired
    public void setPmsProjectbaseCddwDao(PmsProjectbaseCddwDao pmsProjectbaseCddwDao) {

        this.setGenericDao(pmsProjectbaseCddwDao);
    }
