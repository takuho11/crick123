 ...
 */
@Entity
@Table(name = "PMS_PROJECTBASE_JFJD")
@ClassInfo(name = "计划项目-经费进度", module = SysModuleEnum.DECLARE, level = ClassLevelEnum.POJO)
@JsonIgnoreProperties(ignoreUnknown = true)
public class PmsProjectbaseJfjd {
     ...
     *  总额(万元)
     */
    @ApiModelProperty("总额(万元)")
    @TableField("TOTAL")
    @Column(columnDefinition = "TOTAL")
    @FieldDes(name = "total", type = "BigDecimal", memo = "总额(万元)")
    private BigDecimal total;

    /**
     *  其中：科技经费(万元)
     */
    @ApiModelProperty("其中：科技经费(万元)")
    @TableField("TECH_FUNDS")
    @Column(columnDefinition = "TECH_FUNDS")
    @FieldDes(name = "tech_funds", type = "BigDecimal", memo = "其中：科技经费(万元)")
    private BigDecimal techFunds;
    ...
    *  其中：科技经费(万元)
    */
    public BigDecimal getTechFunds (){
        return techFunds;
    }
    public void setTechFunds (BigDecimal techFunds){
        this.techFunds = techFunds;
    }
