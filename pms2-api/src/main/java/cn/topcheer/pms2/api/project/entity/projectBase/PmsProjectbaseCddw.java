 ...
 */
@Entity
@Table(name = "PMS_PROJECTBASE_CDDW")
@ClassInfo(name = "计划项目-承担单位", module = SysModuleEnum.DECLARE, level = ClassLevelEnum.POJO)
@JsonIgnoreProperties(ignoreUnknown = true)
public class PmsProjectbaseCddw {
    ...
    @Column(columnDefinition = "CONTACT_ADDRESS")
    ...
    @TableField("UNIT_SHORT_NAME")
    @Column(columnDefinition = "UNIT_SHORT_NAME")
    private String unitShortName;

    /**
     *  是否承担单位
     */
    @ApiModelProperty("是否承担单位")
    @TableField("IS_CONSTRUCT_UNIT")
    @Column(columnDefinition = "IS_CONSTRUCT_UNIT")
    private String isConstructUnit;
    ...
    public String getIsConstructUnit() {
        return isConstructUnit;
    }

    public void setIsConstructUnit(String isConstructUnit) {
        this.isConstructUnit = isConstructUnit;
    }
}