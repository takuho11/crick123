 ...
 */
@Entity
@Table(name="PMS_PRIZE_THESIS_OTHER")
@ClassInfo(name = "科技奖励-论文他引表", module = SysModuleEnum.TECH_AWARDS, level = ClassLevelEnum.POJO)
@JsonIgnoreProperties(ignoreUnknown = true)
public class PmsPrizeThesisOther {
     ...
     *  被引代表性论文专著序号
     */
	@ApiModelProperty("被引代表性论文专著序号")
	@TableField("PAPERNUMBER")
	@Column(columnDefinition = "PAPERNUMBER")
     ...
     *  引文发表时间
     */
	@ApiModelProperty("引文发表时间")
	@TableField("PUBLISHDATE")
	@Column(columnDefinition = "PUBLISHDATE")
	@FieldDes(name = "publishdate", type = "Date", memo = "引文发表时间")
