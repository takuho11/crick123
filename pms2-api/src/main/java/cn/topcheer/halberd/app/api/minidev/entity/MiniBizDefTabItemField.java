...
@Setter
@Getter
@TableName("mini_biz_def_tab_item_field")
@ApiModel(value = "MiniBizDefTabItemField对象", description = "业务分页子项字段表")
public class MiniBizDefTabItemField extends BasicEntity implements Serializable {


    @ApiModelProperty(value = "业务分页子项id")
    @TableField(value = "biz_def_tab_item_id")
    private Long bizDefTabItemId;


    @ApiModelProperty(value = "标准业务分页子项id")
    @TableField(value = "sd_biz_def_tab_item_field_id")
    private Long sdBizDefTabItemFieldId;
    ...
    @ApiModelProperty(value = "下拉字典名称（编码）、下拉属性")
