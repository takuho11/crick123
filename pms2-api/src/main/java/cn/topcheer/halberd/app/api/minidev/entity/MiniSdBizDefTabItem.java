...
@Setter
@Getter
@TableName("mini_sd_biz_def_tab_item")
@ApiModel(value = "MiniSdBizDefTabItem对象", description = "标准业务分页子项表")
public class MiniSdBizDefTabItem extends BasicEntity implements Serializable {
    ...
    @ApiModelProperty(value = "复制标准模板分页子项id")
    @TableField(exist = false)
    private Long copySdBizDefTabItemId;
